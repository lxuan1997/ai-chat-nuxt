...
import { l as parseURL, m as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, k as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, y as createHooks, c as createError$1, z as executeAsync, A as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C7b_YqwS.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-layout" }, _attrs))}><main class="main-content">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CWs_YMMZ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DqGQKSp8.mjs'));
